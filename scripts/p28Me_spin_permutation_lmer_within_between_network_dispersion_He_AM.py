...
# Runs spin permutation for within and between network dispersion hormonal contrasts with lmer (on data male data)
...
WN_dispersion_perm_tval_hormonal_contrast = {'testosterone_t_val': [], 'cortisol_t_val': []}
BN_dispersion_perm_tval_hormonal_contrast = {'testosterone_t_val': [], 'cortisol_t_val': []}
...
for i in range(len(yeo7_networks_array_perm)):
    ...
    WN_dispersion_perm_tval_hormonal_contrast_temp = {'testosterone_t_val': [], 'cortisol_t_val': []}
    ...
    for n in range(7):
        ...
        # define model
        model = sm.MixedLM(endog = sum_of_squares, exog = pd.DataFrame({'testosterone': hormones_28He_AM.z_total_testosterone_saliva, 'cortisol': hormones_28He_AM.z_cortisol_saliva}), groups = hormones_28He_AM.time, exog_re=hormones_28He_AM.session, exog_vc=None)
    ...
    BN_dispersion_perm_tval_hormonal_contrast_temp = {'testosterone_t_val': [], 'cortisol_t_val': []}
    ...
    for n1 in range(7):
        ...
        for n2 in range(7):
            ...
            if n1!=n2 and [n1+1, n2+1] not in pairwise_comparison_order and list(reversed([n1+1, n2+1])) not in pairwise_comparison_order:
                ...
                # define model
                model = sm.MixedLM(endog = BN_dispersion, exog = pd.DataFrame({'testosterone': hormones_28He_AM.z_total_testosterone_saliva, 'cortisol': hormones_28He_AM.z_cortisol_saliva}), groups = hormones_28He_AM.time, exog_re=hormones_28He_AM.session, exog_vc=None)
...
print(f'\n---- Export results at /data/p_02667/28Me/results/WN and BN_dispersion_perm_tval_hormonal_contrast_null_distr_He_AM.csv ----')
...
# export 
pd.DataFrame(WN_dispersion_perm_tval_testosterone_contrast_null_distr).to_csv(resdir+'WN_dispersion_perm_tval_testosterone_contrast_null_distr_He_AM.csv', header = True, index = False)
pd.DataFrame(WN_dispersion_perm_tval_cortisol_contrast_null_distr).to_csv(resdir+'WN_dispersion_perm_tval_cortisol_contrast_null_distr_He_AM.csv', header = True, index = False)

BN_dispersion_perm_tval_testosterone_contrast_null_distr.to_csv(resdir+'BN_dispersion_perm_tval_testosterone_contrast_null_distr_He_AM.csv', header = True, index = False)
BN_dispersion_perm_tval_cortisol_contrast_null_distr.to_csv(resdir+'BN_dispersion_perm_tval_cortisol_contrast_null_distr_He_AM.csv', header = True, index = False)
