...
# Runs spin permutation for within and between network dispersion hormonal contrasts with lmer: supplementary analysis female reduced sample (Me = 15)
...
#from permutation_testing.py import *
...
# hormone data
hormones_28Me_excl26 = pd.read_csv(resdir+'hormones_Me_15.csv', index_col = 0)
...
WN_dispersion_perm_tval_hormonal_contrast = {'estradiol_t_val': [], 'testosterone_t_val': []}
BN_dispersion_perm_tval_hormonal_contrast = {'estradiol_t_val': [], 'testosterone_t_val': []}
...
for i in range(len(yeo7_networks_array_perm)):
    ...
    WN_dispersion_perm_tval_hormonal_contrast_temp = {'estradiol_t_val': [], 'testosterone_t_val': []}
    ...
    BN_dispersion_perm_tval_hormonal_contrast_temp = {'estradiol_t_val': [], 'testosterone_t_val': []}
...
print(f'\n---- Export results at /data/p_02667/28Me/results/WN and BN_dispersion_perm_tval_hormonal_contrast_null_distr_Me_suppl_15.csv ----')
...
# contains the null distribution of t values for the hormonal contrasts on the Between Network pairwise comparisons (21)
...
# export 
pd.DataFrame(WN_dispersion_perm_tval_estradiol_contrast_null_distr).to_csv(resdir+'WN_dispersion_perm_tval_estradiol_contrast_null_distr_Me_suppl_15.csv', header = True, index = False)
pd.DataFrame(WN_dispersion_perm_tval_testosterone_contrast_null_distr).to_csv(resdir+'WN_dispersion_perm_tval_testosterone_contrast_null_distr_Me_suppl_15.csv', header = True, index = False)

BN_dispersion_perm_tval_estradiol_contrast_null_distr.to_csv(resdir+'BN_dispersion_perm_tval_estradiol_contrast_null_distr_Me_suppl_15.csv', header = True, index = False)
BN_dispersion_perm_tval_testosterone_contrast_null_distr.to_csv(resdir+'BN_dispersion_perm_tval_testosterone_contrast_null_distr_Me_suppl_15.csv', header = True, index = False)
