...
# Runs spin permutation for within and between network dispersion supplementary contrasts with both hormonal and pss covariates in lmer (on data excluding day 26)
...
# stress data
behavior_28Me_excl26 = pd.read_csv(resdir+'behavior_28Me_excl26.csv', index_col = 0)
...
### Compute within and between network dispersion & hormonal/stress contrast -- same code as for original, only differences: 
...
WN_dispersion_perm_tval_hormonal_contrast = {'estradiol_t_val': [], 'progesterone_t_val': [], 'PSS_t_val': []}
BN_dispersion_perm_tval_hormonal_contrast = {'estradiol_t_val': [], 'progesterone_t_val': [], 'PSS_t_val': []}
...
for i in range(len(yeo7_networks_array_perm)):
    ...
    WN_dispersion_perm_tval_hormonal_contrast_temp = {'estradiol_t_val': [], 'progesterone_t_val': [], 'PSS_t_val': []}
    ...
    for n in range(7):
        ...
        # define model
        model = sm.MixedLM(endog = sum_of_squares, exog = pd.DataFrame({'estradiol': hormones_28Me_excl26.z_estradiol, 'progesterone': hormones_28Me_excl26.z_progesterone, 'PSS': behavior_28Me_excl26.z_PSS}), groups = hormones_28Me_excl26.Experiment, exog_re=hormones_28Me_excl26.ExperimentDay, exog_vc=None)
    ...
    BN_dispersion_perm_tval_hormonal_contrast_temp = {'estradiol_t_val': [], 'progesterone_t_val': [], 'PSS_t_val': []}
    ...
    for n1 in range(7):
        ...
        for n2 in range(7):
            ...
            if n1!=n2 and [n1+1, n2+1] not in pairwise_comparison_order and list(reversed([n1+1, n2+1])) not in pairwise_comparison_order:
                ...
                # define model
                model = sm.MixedLM(endog = BN_dispersion, exog = pd.DataFrame({'estradiol': hormones_28Me_excl26.z_estradiol, 'progesterone': hormones_28Me_excl26.z_progesterone, 'PSS': behavior_28Me_excl26.z_PSS}), groups = hormones_28Me_excl26.Experiment, exog_re=hormones_28Me_excl26.ExperimentDay, exog_vc=None)
...
print(f'\n---- Export results at /data/p_02667/28Me/results/WN and BN_dispersion_perm_tval_hormonal_contrast_null_distr_Me_suppl_estr_prog_pss.csv ----')
...
# contains the null distribution of t values for the hormonal contrasts (estradiol, progesterone, PSS separately) on the Within Network dispersion per network (7)
...
# export 
pd.DataFrame(WN_dispersion_perm_tval_estradiol_contrast_null_distr).to_csv(resdir+'WN_dispersion_perm_tval_estradiol_contrast_null_distr_Me_suppl_estr_prog_pss.csv', header = True, index = False)
pd.DataFrame(WN_dispersion_perm_tval_progesterone_contrast_null_distr).to_csv(resdir+'WN_dispersion_perm_tval_progesterone_contrast_null_distr_Me_suppl_estr_prog_pss.csv', header = True, index = False)
pd.DataFrame(WN_dispersion_perm_tval_PSS_contrast_null_distr).to_csv(resdir+'WN_dispersion_perm_tval_PSS_contrast_null_distr_Me_suppl_estr_prog_pss.csv', header = True, index = False)

BN_dispersion_perm_tval_estradiol_contrast_null_distr.to_csv(resdir+'BN_dispersion_perm_tval_estradiol_contrast_null_distr_Me_suppl_estr_prog_pss.csv', header = True, index = False)
BN_dispersion_perm_tval_progesterone_contrast_null_distr.to_csv(resdir+'BN_dispersion_perm_tval_progesterone_contrast_null_distr_Me_suppl_estr_prog_pss.csv', header = True, index = False)
BN_dispersion_perm_tval_PSS_contrast_null_distr.to_csv(resdir+'BN_dispersion_perm_tval_PSS_contrast_null_distr_Me_suppl_estr_prog_pss.csv', header = True, index = False)
