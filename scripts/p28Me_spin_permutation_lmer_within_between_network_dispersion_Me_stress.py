...
print(f'\n---- Export results at /data/p_02667/28Me/results/WN and BN_dispersion_perm_tval_stress_contrast_null_distr_Me.csv ----')
...
# export 
pd.DataFrame(WN_dispersion_perm_tval_stress_contrast_null_distr).to_csv(resdir+'WN_dispersion_perm_tval_stress_contrast_null_distr_Me.csv', header = True, index = False)


BN_dispersion_perm_tval_stress_contrast_null_distr.to_csv(resdir+'BN_dispersion_perm_tval_stress_contrast_null_distr_Me.csv', header = True, index = False)
