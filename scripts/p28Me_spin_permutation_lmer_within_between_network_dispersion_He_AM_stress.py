...
# Runs spin permutation for within and between network dispersion stress contrast with lmer (on male data)
...
# lists that will contain the permutation t-values (null distribution of t-values) for WN and BN dispersion preceived stress contrasts
...
for i in range(len(yeo7_networks_array_perm)):
    ...
    # list that will contain the current permuation's t values (len of lists is 7 because will contain all 7 networks per permutation iteration)
    ...
    # list that will contain the current permuation's t values (len 21 because will contain all 21 comparisons of networks per permutation iteration)
...
print(f'\n---- Export results at /data/p_02667/28Me/results/WN and BN_dispersion_perm_tval_stress_contrast_null_distr_He_AM.csv ----')
...
# export 
pd.DataFrame(WN_dispersion_perm_tval_stress_contrast_null_distr).to_csv(resdir+'WN_dispersion_perm_tval_stress_contrast_null_distr_He_AM.csv', header = True, index = False)


BN_dispersion_perm_tval_stress_contrast_null_distr.to_csv(resdir+'BN_dispersion_perm_tval_stress_contrast_null_distr_He_AM.csv', header = True, index = False)
