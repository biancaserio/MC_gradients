...
# contains the null distribution of t values for the hormonal contrasts contrast on the Between Network pairwise comparisons (21)
...
# export 
pd.DataFrame(WN_dispersion_perm_tval_estradiol_contrast_null_distr).to_csv(resdir+'WN_dispersion_perm_tval_estradiol_contrast_null_distr_He_AM_suppl.csv', header = True, index = False)
pd.DataFrame(WN_dispersion_perm_tval_testosterone_contrast_null_distr).to_csv(resdir+'WN_dispersion_perm_tval_testosterone_contrast_null_distr_He_AM_suppl.csv', header = True, index = False)

BN_dispersion_perm_tval_estradiol_contrast_null_distr.to_csv(resdir+'BN_dispersion_perm_tval_estradiol_contrast_null_distr_He_AM_suppl.csv', header = True, index = False)
BN_dispersion_perm_tval_testosterone_contrast_null_distr.to_csv(resdir+'BN_dispersion_perm_tval_testosterone_contrast_null_distr_He_AM_suppl.csv', header = True, index = False)
