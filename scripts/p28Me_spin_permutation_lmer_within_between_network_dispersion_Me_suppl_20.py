...
# Runs spin permutation for within and between network dispersion hormonal contrasts with lmer: supplementary analysis female reduced sample (Me = 20)
...
print(f'\n---- Export results at /data/p_02667/28Me/results/WN and BN_dispersion_perm_tval_hormonal_contrast_null_distr_Me_suppl_20.csv ----')
...
# export 
pd.DataFrame(WN_dispersion_perm_tval_estradiol_contrast_null_distr).to_csv(resdir+'WN_dispersion_perm_tval_estradiol_contrast_null_distr_Me_suppl_20.csv', header = True, index = False)
pd.DataFrame(WN_dispersion_perm_tval_progesterone_contrast_null_distr).to_csv(resdir+'WN_dispersion_perm_tval_progesterone_contrast_null_distr_Me_suppl_20.csv', header = True, index = False)

BN_dispersion_perm_tval_estradiol_contrast_null_distr.to_csv(resdir+'BN_dispersion_perm_tval_estradiol_contrast_null_distr_Me_suppl_20.csv', header = True, index = False)
BN_dispersion_perm_tval_progesterone_contrast_null_distr.to_csv(resdir+'BN_dispersion_perm_tval_progesterone_contrast_null_distr_Me_suppl_20.csv', header = True, index = False)
