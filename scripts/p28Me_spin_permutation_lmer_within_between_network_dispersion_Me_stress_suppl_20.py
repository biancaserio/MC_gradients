...
# export 
pd.DataFrame(WN_dispersion_perm_tval_stress_contrast_null_distr).to_csv(resdir+'WN_dispersion_perm_tval_stress_contrast_null_distr_Me_suppl_20.csv', header = True, index = False)


BN_dispersion_perm_tval_stress_contrast_null_distr.to_csv(resdir+'BN_dispersion_perm_tval_stress_contrast_null_distr_Me_suppl_20.csv', header = True, index = False)
